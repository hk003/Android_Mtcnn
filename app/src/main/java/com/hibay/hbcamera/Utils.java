...
public class Utils {
    ...
    public static void drawPoints(Bitmap bitmap, Point[] landmark){
        ...
        //drawRect(bitmap,new Rect(landmark[0].x-10,landmark[0].y-10,landmark[0].x+10,landmark[0].y+10));
        //crop_and_resize(bitmap,boxes.get(i),24,curCrop);
//        Matrix matrix = new Matrix();
//        matrix.postScale(1, 1);
//        Bitmap croped=Bitmap.createBitmap(bitmap, landmark[0].x-10,landmark[0].y-10,landmark[0].x+10,landmark[0].y+10,matrix,true);
    }
    //Flip alone diagonal
